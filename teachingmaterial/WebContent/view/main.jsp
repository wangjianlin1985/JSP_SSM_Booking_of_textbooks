			...
			$(function () {
				...
				if(parseInt("${user.role}")==1){
					data=[{
					    ...
					    {id: '02',text: '我的分数', icon: 'fa fa-gg',url: 'score/stu_scoreHtml.htm'},
					    {id: '05',text: '教材信息', icon: 'fa fa-book',url: 'book/stuBookHtml.htm'},
					    {id: '06',text: '领用信息', icon: 'fa fa-window-restore',url: 'receive/receiveStuHtml.htm'},
				...
				if(parseInt("${user.role}")==2){
					data=[{
					    ...
					    {id: '02',text: '学生信息', icon: 'fa fa-group',url: 'student/tea_studentHtml.htm'},
					    {id: '03',text: '添加分数', icon: 'fa fa-gg',url: 'score/tea_scoreHtml.htm'},
					    {id: '05',text: '教材信息', icon: 'fa fa-book',url: 'book/stuBookHtml.htm'},
					    {id: '06',text: '领用信息', icon: 'fa fa-window-restore',url: 'receive/receiveteaHtml.htm'},
					    ]	
					}
				if(parseInt("${user.role}")==3){
					data=[{
					     ...
					     menus: [
					    	 {id: '11',text: '学期',icon: 'icon-glass',url: 'term/termHtml.htm'},
					    	 {id: '12',text: '班级',icon: 'icon-glass',url: 'tClass/classHtml.htm'},
					    	 {id: '13',text: '教室',icon: 'icon-glass',url: 'room/roomHtml.htm'},
					    	 {id: '14',text: '科目',icon: 'icon-glass',url: 'course/courseHtml.htm'},
					    	 {id: '15',text: '系',icon: 'icon-glass',url: 'serie/serieHtml.htm'},
					    	 {id: '16',text: '专业',icon: 'icon-glass',url: 'profession/professionHtml.htm'},
					    	 {id: '17',text: '教材类别',icon: 'icon-glass',url: 'type/typeHtml.htm'},
					    	 /*  {id: '17',text: '药品',icon: 'icon-glass',url: 'mechine/mechineHtml.htm'}, */
					    	 ]
					    },
					    {id: '02',text: '学生信息', icon: 'fa fa-group',url: 'student/studentHtml.htm'},
					    {id: '03',text: '老师信息', icon: 'fa fa-user-o',url: 'teacher/teacherHtml.htm'},
					    {id: '05',text: '教材信息', icon: 'fa fa-book',url: 'book/bookHtml.htm'},
					    {id: '06',text: '领用信息', icon: 'fa fa-window-restore',url: 'receive/receiveHtml.htm'},
					    {id: '07',text: '查看库存', icon: 'fa fa-list',url: 'inventory/inventoryHtml.htm'},
					    /*  {id: '04',text: '公告信息', icon: 'fa fa-file-text-o',url: 'notice/noticeHtml.htm'} */
					    ]
				}
